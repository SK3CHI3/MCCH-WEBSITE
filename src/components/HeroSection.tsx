    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {(() => {
        ...
        return (
          <div className="absolute inset-0 z-0">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-primary/60 via-primary/30 to-primary/10" />
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Description */}
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-primary-foreground/90 mb-6 md:mb-8 leading-relaxed max-w-2xl mx-auto animate-fade-in">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 mb-8 md:mb-12 animate-fade-in justify-center">
            <Button 
              size="default"
          ...
          <div className="grid grid-cols-3 gap-3 md:gap-6 animate-fade-in max-w-2xl mx-auto">
            <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-2 md:p-3 text-center">
              <Users className="h-4 w-4 md:h-6 md:w-6 text-primary-foreground mx-auto mb-1 md:mb-2" />
              <div className="text-base md:text-xl font-bold text-primary-foreground mb-0.5">150+</div>
              <div className="text-xs text-primary-foreground/80 leading-tight">Children Cared For</div>
            </div>
            <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-2 md:p-3 text-center">
              <BookOpen className="h-4 w-4 md:h-6 md:w-6 text-primary-foreground mx-auto mb-1 md:mb-2" />
              <div className="text-base md:text-xl font-bold text-primary-foreground mb-0.5">12+</div>
              <div className="text-xs text-primary-foreground/80 leading-tight">Years of Service</div>
            </div>
            <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-2 md:p-3 text-center">
              <Heart className="h-4 w-4 md:h-6 md:w-6 text-primary-foreground mx-auto mb-1 md:mb-2 fill-primary-foreground" />
              <div className="text-base md:text-xl font-bold text-primary-foreground mb-0.5">500+</div>
              <div className="text-xs text-primary-foreground/80 leading-tight">Lives Transformed</div>
            </div>
          </div>
        </div>
      </div>
